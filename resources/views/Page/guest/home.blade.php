    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span class="ml-3 text-xl text-gray-800">TuMenuQR<span class="text-pink-500">.</span></span>
            </a>
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Solicita tu menu virtual</h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Accede con el codigo QR y podras ver tu menu con todos tus productos y categorias</p>
            ...
            <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Facil gestion</h4>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Acceso QR</h4>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Carga inicial</h4>
                ...
                <div class="relative flex flex-col items-center block sm:flex-row">
                    ...
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white border-t border-gray-100 rounded-lg shadow-sm">
                            <div
                                ...
                                <h3 class="p-3 text-lg font-bold tracking-wide text-center uppercase">Plan<span
                                        class="ml-2 font-light">Basico</span></h3>
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                                    <span class="mr-1 -ml-2 text-lg text-gray-700">$</span>1500</h4>
                                <p class="text-sm text-gray-600">Si tienes pocos productos que ofrecer este es el tuyo
                                </p>
                            </div>
                            ...
                            <div class="flex flex-wrap px-6 mt-8">
                                <ul>
                                    <li class="flex items-center">
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">5 Categorias</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">20 Productos</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">1 Destacado</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="flex items-center p-8 uppercase">
                                <a href="https://api.whatsapp.com/send/?phone=5492396513953&amp;text=Quier saber mas sobre TuMenuQR" target="_blank"
                                    class="block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-green-600">Contratar Plan</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                            <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Plan<span
                                    class="ml-2 font-light">Intermedio</span></h3>
                            <h4
                                class="flex items-center justify-center pb-6 text-5xl font-bold text-center text-gray-900">
                                <span class="mr-1 -ml-2 text-lg text-gray-700">$</span>3000</h4>
                            <p class="text-sm text-gray-600">Ideal para comercios, roticerias, y bares</p>
                        </div>
                        <div class="flex justify-start pl-12 mt-8 sm:justify-start">
                            <ul>
                                <li class="flex items-center">
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">10 Categorias</span>
                                </li>
                                <li class="flex items-center">
                                    <div class="p-2 text-green-500 rounded-full fill-current ">
                                        <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">50 Productos</span>
                                </li>
                                <li class="flex items-center">
                                    <div class="p-2 text-green-500 rounded-full fill-current ">
                                        <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">3 Destacados</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white rounded-lg shadow-lg shadow-inner">
                            <div
                                ...
                                <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Plan<span
                                        class="ml-2 font-light">Completo</span></h3>
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                                    <span class="mr-1 -ml-2 text-lg text-gray-700">$</span>5000</h4>
                                <p class="pl-2 text-sm text-gray-600">Util para mostrar toda la amplia gama de productos y variedades de tu comercio</p>
                            </div>
                            <div class="flex flex-wrap px-8 mt-8">
                                <ul>
                                    <li class="flex items-center">
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">20 Categorias</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">500 Productos</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">10 Destacados</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="flex items-center block p-8 uppercase">
                                <a href="https://api.whatsapp.com/send/?phone=5492396513953&amp;text=Quier saber mas sobre TuMenuQR" target="_blank"
                                    class="block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-green-600">Quiero contratarlo</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Muy lindo como queda el menu.
                                    </p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Ramona
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Pehuajo</span>
                                </h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Me encanta y util el QR.</p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Restaurant Italiano <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- 9 de Julio </span></h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
    ...
    <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
        <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
            <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
                ...
                <p class="mt-6 mr-4 text-base text-gray-500">Accede con el codigo QR y podras ver tu menu con todos tus productos y categorias.
                </p>
            </div>
        ...
        <div class="pt-4 pt-6 mt-10 text-center text-gray-400 border-t border-gray-100">© {{date('Y')}} Femaser. All rights
            reserved.</div>
    </footer>
