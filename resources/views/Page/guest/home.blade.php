        ...
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            ...
            <div class="w-full my-4 flex flex-col items-center gap-3 justify-around sm:flex-row">
                ...
                <div class="w-full md:w-2/6 flex flex-col items-center bg-gray-50 border border-gray-200 rounded-lg shadow md:max-w-xl hover:bg-gray-100">
                    <img class="object-cover w-full rounded-t-lg h-80 md:h-auto md:w-full md:rounded-none md:rounded-s-lg" lazy="loading" src="{{ asset('archives/sistem/img/demo1.jpg') }}" alt="">
                ...
                <div class="w-full md:w-2/6 flex flex-col items-center bg-gray-50 border border-gray-200 rounded-lg shadow md:max-w-xl hover:bg-gray-100">
                    <img class="object-cover w-full rounded-t-lg h-80 md:h-auto md:w-full md:rounded-none md:rounded-s-lg" lazy="loading" src="{{ asset('archives/sistem/img/demo2.jpg') }}" alt="">
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <p class="mb-3 font-normal text-sm italic text-gray-700">(Version Intermedia)</p>
