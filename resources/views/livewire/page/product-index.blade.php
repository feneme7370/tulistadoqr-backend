            ...
            <form {{-- method="POST" --}} class="grid gap-3 mt-5">
                <div class="grid md:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <x-sistem.forms.input-form id="price_original" type="number" placeholder="{{ __('Ingresar el precio') }}" wire:model="price_original"
                            autofocus />
                    ...
                    <div>
                        ...
                        <x-sistem.forms.input-form id="price_seller" type="number" placeholder="{{ __('Ingresar el precio') }}" wire:model="price_seller"
                            autofocus />
                    ...
                    <div>
                        ...
                        <x-sistem.forms.input-form id="quantity" type="number" placeholder="{{ __('Ingresar la cantidad') }}" wire:model="quantity"
                            autofocus />
                    ...
                    {{-- <div>
                        <x-sistem.forms.label-form for="image_text_hero" value="{{ __('Link imagen') }}" />
                        <x-sistem.forms.input-form id="image_text_hero" type="text" placeholder="{{ __('https://') }}" wire:model="image_text_hero"
                         />
                        <x-sistem.forms.input-error for="image_text_hero" />
                    </div> --}}
                    ...
                    <div>
                        ...
                        <x-sistem.forms.input-form id="image_hero_nueva" type="file" wire:model="image_hero_nueva" accept="image/*"
                             />
                ...
                <div class="flex flex-col md:flex-row justify-evenly mb-4">
                    <div class="w-64 h-64 relative">
                        ...
                        @if ($this->image_hero && $this->image_hero != '')
                            <img src="{{asset('storage/images/product/'.$this->image_hero)}}" alt="imagen" class="w-64 h-64 object-cover rounded-sm" />
