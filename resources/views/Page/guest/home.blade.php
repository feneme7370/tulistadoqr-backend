...
<body class="overflow-x-hidden antialiased scroll-smooth">
    ...
    <header class="relative z-50 w-full h-24">
        <div class="block sm:hidden bg-primary-200 p-1">
            <a href="{{route('login')}}" class="w-full block mx-auto text-sm font-bold text-center text-primary-800 hover:text-primary-600 underline">Acceso</a>
        </div>
        <div
            ...
            <nav id="nav"
                ...
                <a href="#demos"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-primary-600">Ejemplos</a>
                <a href="#pricing"
    ...
    <div id="demos" class="relative w-full px-8 py-2 md:py-8 lg:py-16 xl:py-24 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            <h2 class="mt-5 mb-10 text-base font-medium tracking-tight text-primary-500 uppercase">Mira dos ejemplos reales</h2>
            <hr class="border border-primary-900 w-full mb-5">
            <div class="w-full my-4 flex flex-col items-center gap-3 justify-around sm:flex-row">

                <div class="w-full md:w-2/6 flex flex-col items-center bg-gray-50 border border-gray-200 rounded-lg shadow md:max-w-xl hover:bg-gray-100">
                    <img class="object-cover w-full rounded-t-lg h-80 md:h-auto md:w-full md:rounded-none md:rounded-s-lg" lazy="loading" src="{{ asset('archives/sistem/img/demo1.jpeg') }}" alt="">
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <p class="mb-3 font-normal text-sm italic text-gray-700">(Version Completa)</p>
                        <a href="https://meriendalunas.femaser.com/" target="_blank"
                        class="relative inline-block w-full p-2 text-sm rounded-2xl text-center text-gray-100 bg-primary-900 hover:bg-primary-700 fold-bold">Ver pagina</a>
                    </div>
                </div>
                <div class="w-full md:w-2/6 flex flex-col items-center bg-gray-50 border border-gray-200 rounded-lg shadow md:max-w-xl hover:bg-gray-100">
                    <img class="object-cover w-full rounded-t-lg h-80 md:h-auto md:w-full md:rounded-none md:rounded-s-lg" lazy="loading" src="{{ asset('archives/sistem/img/demo2.jpeg') }}" alt="">
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">La pasta di Federico</h5>
                        <p class="mb-3 font-normal text-gray-700">Pastas Caseras.</p>
                        <p class="mb-3 font-normal text-sm italic text-gray-700">(Version Completa)</p>
                        <a href="https://lapastadifederico.femaser.com/" target="_blank"
                        class="relative inline-block w-full p-2 text-sm rounded-2xl text-center text-gray-100 bg-primary-900 hover:bg-primary-700 fold-bold">Ver pagina</a>
                    </div>
                </div>
