            ...
            <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
              <div class="w-full">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <x-sistem.forms.input-form id="password" type="password" placeholder="{{ __('************') }}" wire:model="password" name="password"
                     />
                    
      
                    <!-- You should use a button here, as the anchor is only used for the example  -->
                    <x-sistem.buttons.primary-btn type="submit" class="w-full mt-4" wire:loading.attr="disabled" title="Ingresar"/>
                </form>
