...
class CompanySeeder extends Seeder
{
    ...
    public function run(): void
    {
        Company::create([
            ...
            'status' => '1',
            'type_menu' => '1',
            'image_logo' => '1_1_1707777754_LMlws6u.jpg',
            'image_logo_uri' => 'archives/images/logo/',
            'image_hero' => '1_1_1707777754_CPlQkna.jpg',
            'image_hero_uri' => 'archives/images/hero/',
            'image_qr' => '1_1_1707777755_EjP7ko5.jpg',
        ...
        Company::create([
            ...
            'city' => 'Carlos Casares',
            'social' => '',
            'url' => 'tulistadoqr-demo1.femaser.com',
            'short_description' => 'Veni y pasala genial',
        ...
        Company::create([
            'name' => 'El favorito',
            'slug' => Str::slug('El favorito'),
            'email' => 'elfavorito@gmail.com',
            'phone' => '2395845524',
            'adress' => 'Arenales 962',
            'city' => 'Carlos Casares',
            'social' => '',
            'url' => 'tulistadoqr-demo2.femaser.com',
            'short_description' => 'Veni y pasala genial',
